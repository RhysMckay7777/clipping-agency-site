...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!post) {
    return {
      title: "Post Not Found | Clipping Agency",
    };
  }

  return {
    title: `${post.title} | Clipping Agency Blog`,
...
export default async function BlogPost({ params }: Props) {
  ...
  const articleSchema = {
    ...
    author: {
      "@type": "Person",
      name: post.primary_author?.name || "Clipping Agency Editorial Team",
    },
    publisher: {
      "@type": "Organization",
    ...
    mainEntityOfPage: `https://clippingagency.ai/blog/${slug}`,
          ...
          <footer className="mt-16 pt-8 border-t border-gray-800">
            <section className="bg-gray-900 rounded-lg p-6 mb-8">
              ...
              <p className="font-semibold">
                {post.primary_author?.name || "Clipping Agency Editorial Team"}
              </p>
