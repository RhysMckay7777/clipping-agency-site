...
export const metadata: Metadata = {
  title: "Blog | Clipping Agency",
  description:
    "Insights on content clipping, short-form video distribution, TikTok marketing, and brand growth strategies from Clipping Agency.",
  alternates: {
    canonical: "/blog",
  },
};
